...
?>  
 ...
 <div class="row">
 <div class="col-md-12">
<p class="titulo margem">Taxa de problemas com abandono</p>
<a href="gerar_abandono"><button class="btn btn-primary">Gerar Planilha</button></a>
<br><br>
...
<table class="table table-secondary">
  <thead>
    <tr>
      <th scope="col">Descrição do caso:</th>
